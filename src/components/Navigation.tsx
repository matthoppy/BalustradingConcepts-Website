...
import { Menu, X, ChevronDown, Fence, Waves, Fan } from "lucide-react";
...
const Navigation = () => {
  ...
  const serviceItems = [
    { label: "Balustrades", href: "/balustrades", icon: Fence },
    { label: "Pool Fences", href: "/pool-fencing", icon: Waves },
