...
interface TermsOfTradeModalProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

const TermsOfTradeModal = ({ open, onOpenChange }: TermsOfTradeModalProps) => {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[85vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold">Terms & Conditions of Trade</DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-6 mt-4 text-sm">
          ...
          {/* 2. Acceptance */}
          <section>
            <h2 className="text-lg font-semibold mb-2">2. Acceptance</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold mb-2">3. Collection and Use of Information</h2>
            <div className="text-muted-foreground space-y-2">
          ...
          {/* 4. Price */}
          <section>
            <h2 className="text-lg font-semibold mb-2">4. Price</h2>
            <div className="text-muted-foreground space-y-2">
          ...
          {/* 6. Quotation */}
          <section>
            <h2 className="text-lg font-semibold mb-2">6. Quotation</h2>
            <div className="text-muted-foreground space-y-2">
          ...
          <section>
            <h2 className="text-lg font-semibold mb-2">7. Title and Security (Personal Property Securities Act 1999)</h2>
            <div className="text-muted-foreground space-y-2">
          ...
          {/* 8. Disputes */}
          <section>
            <h2 className="text-lg font-semibold mb-2">8. Disputes</h2>
            <div className="text-muted-foreground">
          ...
          {/* 9. Liability */}
          <section>
            <h2 className="text-lg font-semibold mb-2">9. Liability</h2>
            <div className="text-muted-foreground space-y-2">
          ...
          {/* 10. Warranty */}
          <section>
            <h2 className="text-lg font-semibold mb-2">10. Warranty</h2>
            <div className="text-muted-foreground space-y-2">
          ...
          <section>
            <h2 className="text-lg font-semibold mb-2">11. Consumer Guarantees Act</h2>
            <div className="text-muted-foreground">
          ...
          <section>
            <h2 className="text-lg font-semibold mb-2">12. Personal Guarantee of Company Directors or Trustees</h2>
            <div className="text-muted-foreground">
          ...
          {/* 13. Miscellaneous */}
          <section>
            <h2 className="text-lg font-semibold mb-2">13. Miscellaneous</h2>
            <div className="text-muted-foreground space-y-2">
